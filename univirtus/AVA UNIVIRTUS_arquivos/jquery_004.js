...
$.extend($.validator, {
	...
	messages: {
		...
		maxlength: $.validator.format("Forneça não mais do que {0} caracteres."),
		minlength: $.validator.format("Forneça ao menos {0} caracteres."),
		rangelength: $.validator.format("Informe um valor entre {0} e {1} número de caracteres."),
